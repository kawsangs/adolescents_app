...
import {iPhoneStatusBarHeight} from '../../constants/ios_component_constant';
...
const PlayVideoWarningMessageComponent = (props) => {
  ...
  const closeButton = () => {
    return <TouchableOpacity onPress={() => props.closeModal()}
              style={{width: componentUtil.pressableItemSize(), height: componentUtil.pressableItemSize(), justifyContent: 'center', alignItems: 'center', marginTop: iPhoneStatusBarHeight, marginLeft: getStyleOfDevice(16, 0)}}
           >
