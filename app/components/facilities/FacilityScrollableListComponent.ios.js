...
const FacilityScrollableListComponent = (props) => {
  ...
  return <CustomFlatListComponent
            ...
            renderItem={({item}) => <FacilityCardItemComponent facility={item} facilityImages={props.facilityImages} containerStyle={props.itemContainerStyle} accessibilityLabel={item.name} />}
