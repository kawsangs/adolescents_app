...
const IntroDoneButtonComponent = (props) => {
  ...
  return (
    <View style={{alignItems: 'center', backgroundColor: color.primaryColor, borderRadius: 40, elevation: 4, height: componentUtil.mediumPressableItemSize(), justifyContent: 'center'}}>
