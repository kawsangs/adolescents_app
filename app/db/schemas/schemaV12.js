...
import Category from '../migrations/v11/category';
import Facility from '../migrations/v11/facility';
import Video from '../migrations/v8/video';
import Topic from '../migrations/v11/topic';
import Question from '../migrations/v11/question';
import Tag from '../migrations/v5/tag';
import Notification from '../migrations/v9/notification';
import User from '../migrations/v11/user';
